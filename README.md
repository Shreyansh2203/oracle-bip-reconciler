...
### Priority 4: [DISABLED] Date + Amount ONLY
*(Note: This priority is currently disabled because the Oracle Receipt Report does not natively support bulk Date/Amount queries without a reference).*
